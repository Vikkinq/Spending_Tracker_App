        ...
        <div class="max-w-md mx-auto bg-white rounded-lg shadow-md p-8">
            ...
            <form @submit.prevent="onSubmit" class="space-y-5">
                ...
                <div>
                    ...
                    <textarea v-model="form.note" id="note" placeholder="Add a note..." rows="4" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent outline-none transition resize-none"></textarea>
                </div>
